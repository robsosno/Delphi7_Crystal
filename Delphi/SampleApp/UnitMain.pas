...
begin
  ...
  RegIni := nil;
  try
    RegIni := TRegIniFile.Create('Software\Crystal Decisions\9.0\CrystalVCL');
  except
    if RegIni <> nil then
      RegIni.Free;
    Exit;
...
var
  ...
  begin
    ...
    try
      ...
      if not Reg1.OpenKey('\SOFTWARE\Crystal Decisions\9.0\Crystal Reports', False) then
        Exit;
...
begin
  ...
  begin
    RegIni := TRegIniFile.Create('Software\Crystal Decisions\9.0\');
    try
