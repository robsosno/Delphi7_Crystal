...
-----------------------------------------------------------
 ...
 Version:            $Revision: #4 $
 Last Modified Date: $Date: 2003/07/17 $
...
begin
  ...
  begin
    ...
    case FDataSet.Fields[FieldIndex].DataType of
      ...
      ftBlob        : pVal := varArray;
      ftMemo        : pVal := varVariant;
      ftGraphic     : pVal := varArray;
      ftFmtMemo     : pVal := varVariant;
      ftParadoxOle  : pVal := varUnknown;
      ftDBaseOle    : pVal := varUnknown;
      ftTypedBinary : pVal := varVariant;
      ftCursor      : pVal := varVariant;
      ftFixedChar   : pVal := varVariant;
      ftWideString  : pVal := varOleStr;
      ftLargeint    : pVal := varInteger;
      ftADT         : pVal := varVariant;
      ftArray       : pVal := varVariant;
      ftReference   : pVal := varVariant;
      ftDataSet     : pVal := varVariant;
      ftOraBlob     : pVal := varArray;
      ftOraClob     : pVal := varVariant;
      ftVariant     : pVal := varVariant;
      ftInterface   : pVal := varDispatch;
      ftIDispatch   : pVal := varDispatch;
